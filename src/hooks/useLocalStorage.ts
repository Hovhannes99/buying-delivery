...
type RemoveItem<T> = (value: string)=> void
export function useLocalStorage<T>(key: string, initialValue?: T, { sync }: UseLocalStorageOpts = {}): [T, SetLocalStorage<T>, RemoveItem<T>] {
